...
if($_COOKIE["count"]<11){
    ...
    $res = $mysqli->query("select id, question from science_questions where done=0 order by rand() limit 1;");
    if ($res === false) {
    ...
    $stmt = $mysqli->prepare("update science_questions set done = ? where id = ?;");
...
if (isset($_POST["questionid"])) {
    ...
    $stmt = $mysqli->prepare("select * from science_questions where id = ?;");
...
<html>
    <head>
        ...
        <meta name="description" content="trivia game science questions">  

        <title>Trivia Game - Science</title>
    ...
    <body>
        <div class="container" style="margin-top: 15px;">
            <div class="row">
                <div class="col-8">
                    <h1>CS4640 Trivia Game - Science & Nature</h1>
            ...
            <div class="row">
                ...
                <form action="questions_science.php" method="post">
