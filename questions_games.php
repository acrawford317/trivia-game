...
if($_COOKIE["count"]<11){
    ...
    $res = $mysqli->query("select id, question from videogames_questions where done=0 order by rand() limit 1;");
    if ($res === false) {
    ...
    $stmt = $mysqli->prepare("update videogames_questions set done = ? where id = ?;");
...
if (isset($_POST["questionid"])) {
    ...
    $stmt = $mysqli->prepare("select * from videogames_questions where id = ?;");
...
<html>
    <head>
        ...
        <meta name="description" content="trivia game video game questions">  

        <title>Trivia Game - Video Games</title>
    ...
    <body>
        <div class="container" style="margin-top: 15px;">
            <div class="row">
                <div class="col-8">
                    <h1>CS4640 Trivia Game - Video Games</h1>
            ...
            <div class="row">
                ...
                <form action="questions_games.php" method="post">
