...
if($_COOKIE["count"]<11){
    ...
    $res = $mysqli->query("select id, question from tv_questions where done=0 order by rand() limit 1;");
    if ($res === false) {
    ...
    $stmt = $mysqli->prepare("update tv_questions set done = ? where id = ?;");
...
if (isset($_POST["questionid"])) {
    ...
    $stmt = $mysqli->prepare("select * from tv_questions where id = ?;");
...
<html>
    <head>
        ...
        <meta name="description" content="trivia game tv questions">  

        <title>Trivia Game - Television</title>
    ...
    <body>
        <div class="container" style="margin-top: 15px;">
            <div class="row">
                <div class="col-8">
                    <h1>CS4640 Trivia Game - Television</h1>
            ...
            <div class="row">
                ...
                <form action="questions_tv.php" method="post">
